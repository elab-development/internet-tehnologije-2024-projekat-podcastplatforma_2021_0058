...
const Favorites = () => {
  const { podcasts, setFilter, getFavoritePodcasts } = usePodcasts();  
  ...
  const paginatedPodcasts = favoritePodcasts.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage);
